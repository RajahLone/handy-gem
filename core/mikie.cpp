...
bool CMikie::ContextSave(FILE *fp)
{
  ...
  if(!afwrite(&mDisplayAddress,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAudioInputComparator,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTimerStatusFlags,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTimerInterruptMask,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(mPalette,sizeof(TPALETTE),16,fp, 4)) return 0;
  if(!afwrite(mColourMap,sizeof(ULONG),4096,fp, 4)) return 0;
  
  if(!afwrite(&mIODAT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mIODAT_REST_SIGNAL,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mIODIR,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mDISPCTL_DMAEnable,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mDISPCTL_Flip,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mDISPCTL_FourColour,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mDISPCTL_Colour,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mTIM_0_BKUP,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_0_ENABLE_RELOAD,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_0_ENABLE_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_0_LINKING,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_0_CURRENT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_0_TIMER_DONE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_0_LAST_CLOCK,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_0_BORROW_IN,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_0_BORROW_OUT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_0_LAST_LINK_CARRY,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_0_LAST_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mTIM_1_BKUP,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_1_ENABLE_RELOAD,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_1_ENABLE_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_1_LINKING,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_1_CURRENT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_1_TIMER_DONE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_1_LAST_CLOCK,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_1_BORROW_IN,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_1_BORROW_OUT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_1_LAST_LINK_CARRY,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_1_LAST_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mTIM_2_BKUP,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_2_ENABLE_RELOAD,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_2_ENABLE_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_2_LINKING,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_2_CURRENT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_2_TIMER_DONE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_2_LAST_CLOCK,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_2_BORROW_IN,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_2_BORROW_OUT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_2_LAST_LINK_CARRY,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_2_LAST_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mTIM_3_BKUP,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_3_ENABLE_RELOAD,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_3_ENABLE_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_3_LINKING,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_3_CURRENT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_3_TIMER_DONE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_3_LAST_CLOCK,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_3_BORROW_IN,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_3_BORROW_OUT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_3_LAST_LINK_CARRY,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_3_LAST_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mTIM_4_BKUP,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_4_ENABLE_RELOAD,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_4_ENABLE_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_4_LINKING,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_4_CURRENT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_4_TIMER_DONE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_4_LAST_CLOCK,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_4_BORROW_IN,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_4_BORROW_OUT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_4_LAST_LINK_CARRY,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_4_LAST_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mTIM_5_BKUP,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_5_ENABLE_RELOAD,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_5_ENABLE_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_5_LINKING,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_5_CURRENT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_5_TIMER_DONE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_5_LAST_CLOCK,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_5_BORROW_IN,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_5_BORROW_OUT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_5_LAST_LINK_CARRY,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_5_LAST_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mTIM_6_BKUP,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_6_ENABLE_RELOAD,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_6_ENABLE_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_6_LINKING,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_6_CURRENT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_6_TIMER_DONE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_6_LAST_CLOCK,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_6_BORROW_IN,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_6_BORROW_OUT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_6_LAST_LINK_CARRY,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_6_LAST_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mTIM_7_BKUP,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_7_ENABLE_RELOAD,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_7_ENABLE_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_7_LINKING,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_7_CURRENT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_7_TIMER_DONE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_7_LAST_CLOCK,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_7_BORROW_IN,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_7_BORROW_OUT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_7_LAST_LINK_CARRY,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mTIM_7_LAST_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mAUDIO_0_BKUP,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_0_ENABLE_RELOAD,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_0_ENABLE_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_0_LINKING,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_0_CURRENT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_0_TIMER_DONE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_0_LAST_CLOCK,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_0_BORROW_IN,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_0_BORROW_OUT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_0_LAST_LINK_CARRY,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_0_LAST_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_0_VOLUME,sizeof(SBYTE),1,fp, 0)) return 0;
  if(!afwrite(&mAUDIO_0_OUTPUT,sizeof(SBYTE),1,fp, 0)) return 0;
  if(!afwrite(&mAUDIO_0_INTEGRATE_ENABLE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_0_WAVESHAPER,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mAUDIO_1_BKUP,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_1_ENABLE_RELOAD,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_1_ENABLE_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_1_LINKING,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_1_CURRENT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_1_TIMER_DONE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_1_LAST_CLOCK,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_1_BORROW_IN,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_1_BORROW_OUT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_1_LAST_LINK_CARRY,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_1_LAST_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_1_VOLUME,sizeof(SBYTE),1,fp, 0)) return 0;
  if(!afwrite(&mAUDIO_1_OUTPUT,sizeof(SBYTE),1,fp, 0)) return 0;
  if(!afwrite(&mAUDIO_1_INTEGRATE_ENABLE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_1_WAVESHAPER,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mAUDIO_2_BKUP,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_2_ENABLE_RELOAD,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_2_ENABLE_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_2_LINKING,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_2_CURRENT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_2_TIMER_DONE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_2_LAST_CLOCK,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_2_BORROW_IN,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_2_BORROW_OUT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_2_LAST_LINK_CARRY,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_2_LAST_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_2_VOLUME,sizeof(SBYTE),1,fp, 0)) return 0;
  if(!afwrite(&mAUDIO_2_OUTPUT,sizeof(SBYTE),1,fp, 0)) return 0;
  if(!afwrite(&mAUDIO_2_INTEGRATE_ENABLE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_2_WAVESHAPER,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mAUDIO_3_BKUP,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_3_ENABLE_RELOAD,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_3_ENABLE_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_3_LINKING,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_3_CURRENT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_3_TIMER_DONE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_3_LAST_CLOCK,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_3_BORROW_IN,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_3_BORROW_OUT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_3_LAST_LINK_CARRY,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_3_LAST_COUNT,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_3_VOLUME,sizeof(SBYTE),1,fp, 0)) return 0;
  if(!afwrite(&mAUDIO_3_OUTPUT,sizeof(SBYTE),1,fp, 0)) return 0;
  if(!afwrite(&mAUDIO_3_INTEGRATE_ENABLE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mAUDIO_3_WAVESHAPER,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mSTEREO,sizeof(ULONG),1,fp, 4)) return 0;
  
  //
  // Serial related variables
  //
  if(!afwrite(&mUART_RX_IRQ_ENABLE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mUART_TX_IRQ_ENABLE,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mUART_TX_COUNTDOWN,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mUART_RX_COUNTDOWN,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mUART_SENDBREAK,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mUART_TX_DATA,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mUART_RX_DATA,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mUART_RX_READY,sizeof(ULONG),1,fp, 4)) return 0;
  
  if(!afwrite(&mUART_PARITY_ENABLE,sizeof(ULONG),1,fp, 4)) return 0;
  if(!afwrite(&mUART_PARITY_EVEN,sizeof(ULONG),1,fp, 4)) return 0;
...
bool CMikie::ContextLoad(LSS_FILE *fp)
{
  ...
  if(!lss_read(teststr,                    sizeof(char),       19, fp, 0)) return 0;
  if(strcmp(teststr,"CMikie::ContextSave")!=0) return 0;
  
  if(!lss_read(&mDisplayAddress,           sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAudioInputComparator,     sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTimerStatusFlags,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTimerInterruptMask,       sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(mPalette,                   sizeof(TPALETTE),   16, fp, 4)) return 0;
  if(!lss_read(mColourMap,                 sizeof(ULONG),    4096, fp, 4)) return 0;
  
  if(!lss_read(&mIODAT,                    sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mIODAT_REST_SIGNAL,        sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mIODIR,                    sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mDISPCTL_DMAEnable,        sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mDISPCTL_Flip,             sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mDISPCTL_FourColour,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mDISPCTL_Colour,           sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mTIM_0_BKUP,               sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_0_ENABLE_RELOAD,      sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_0_ENABLE_COUNT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_0_LINKING,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_0_CURRENT,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_0_TIMER_DONE,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_0_LAST_CLOCK,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_0_BORROW_IN,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_0_BORROW_OUT,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_0_LAST_LINK_CARRY,    sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_0_LAST_COUNT,         sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mTIM_1_BKUP,               sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_1_ENABLE_RELOAD,      sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_1_ENABLE_COUNT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_1_LINKING,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_1_CURRENT,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_1_TIMER_DONE,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_1_LAST_CLOCK,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_1_BORROW_IN,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_1_BORROW_OUT,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_1_LAST_LINK_CARRY,    sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_1_LAST_COUNT,         sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mTIM_2_BKUP,               sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_2_ENABLE_RELOAD,      sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_2_ENABLE_COUNT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_2_LINKING,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_2_CURRENT,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_2_TIMER_DONE,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_2_LAST_CLOCK,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_2_BORROW_IN,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_2_BORROW_OUT,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_2_LAST_LINK_CARRY,    sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_2_LAST_COUNT,         sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mTIM_3_BKUP,               sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_3_ENABLE_RELOAD,      sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_3_ENABLE_COUNT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_3_LINKING,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_3_CURRENT,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_3_TIMER_DONE,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_3_LAST_CLOCK,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_3_BORROW_IN,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_3_BORROW_OUT,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_3_LAST_LINK_CARRY,    sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_3_LAST_COUNT,         sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mTIM_4_BKUP,               sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_4_ENABLE_RELOAD,      sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_4_ENABLE_COUNT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_4_LINKING,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_4_CURRENT,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_4_TIMER_DONE,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_4_LAST_CLOCK,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_4_BORROW_IN,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_4_BORROW_OUT,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_4_LAST_LINK_CARRY,    sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_4_LAST_COUNT,         sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mTIM_5_BKUP,               sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_5_ENABLE_RELOAD,      sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_5_ENABLE_COUNT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_5_LINKING,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_5_CURRENT,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_5_TIMER_DONE,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_5_LAST_CLOCK,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_5_BORROW_IN,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_5_BORROW_OUT,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_5_LAST_LINK_CARRY,    sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_5_LAST_COUNT,         sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mTIM_6_BKUP,               sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_6_ENABLE_RELOAD,      sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_6_ENABLE_COUNT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_6_LINKING,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_6_CURRENT,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_6_TIMER_DONE,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_6_LAST_CLOCK,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_6_BORROW_IN,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_6_BORROW_OUT,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_6_LAST_LINK_CARRY,    sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_6_LAST_COUNT,         sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mTIM_7_BKUP,               sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_7_ENABLE_RELOAD,      sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_7_ENABLE_COUNT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_7_LINKING,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_7_CURRENT,            sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_7_TIMER_DONE,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_7_LAST_CLOCK,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_7_BORROW_IN,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_7_BORROW_OUT,         sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_7_LAST_LINK_CARRY,    sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mTIM_7_LAST_COUNT,         sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mAUDIO_0_BKUP,             sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_0_ENABLE_RELOAD,    sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_0_ENABLE_COUNT,     sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_0_LINKING,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_0_CURRENT,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_0_TIMER_DONE,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_0_LAST_CLOCK,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_0_BORROW_IN,        sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_0_BORROW_OUT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_0_LAST_LINK_CARRY,  sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_0_LAST_COUNT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_0_VOLUME,           sizeof(SBYTE),       1, fp, 0)) return 0;
  if(!lss_read(&mAUDIO_0_OUTPUT,           sizeof(SBYTE),       1, fp, 0)) return 0;
  if(!lss_read(&mAUDIO_0_INTEGRATE_ENABLE, sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_0_WAVESHAPER,       sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mAUDIO_1_BKUP,             sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_1_ENABLE_RELOAD,    sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_1_ENABLE_COUNT,     sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_1_LINKING,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_1_CURRENT,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_1_TIMER_DONE,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_1_LAST_CLOCK,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_1_BORROW_IN,        sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_1_BORROW_OUT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_1_LAST_LINK_CARRY,  sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_1_LAST_COUNT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_1_VOLUME,           sizeof(SBYTE),       1, fp, 0)) return 0;
  if(!lss_read(&mAUDIO_1_OUTPUT,           sizeof(SBYTE),       1, fp, 0)) return 0;
  if(!lss_read(&mAUDIO_1_INTEGRATE_ENABLE, sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_1_WAVESHAPER,       sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mAUDIO_2_BKUP,             sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_2_ENABLE_RELOAD,    sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_2_ENABLE_COUNT,     sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_2_LINKING,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_2_CURRENT,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_2_TIMER_DONE,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_2_LAST_CLOCK,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_2_BORROW_IN,        sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_2_BORROW_OUT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_2_LAST_LINK_CARRY,  sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_2_LAST_COUNT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_2_VOLUME,           sizeof(SBYTE),       1, fp, 0)) return 0;
  if(!lss_read(&mAUDIO_2_OUTPUT,           sizeof(SBYTE),       1, fp, 0)) return 0;
  if(!lss_read(&mAUDIO_2_INTEGRATE_ENABLE, sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_2_WAVESHAPER,       sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mAUDIO_3_BKUP,             sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_3_ENABLE_RELOAD,    sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_3_ENABLE_COUNT,     sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_3_LINKING,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_3_CURRENT,          sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_3_TIMER_DONE,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_3_LAST_CLOCK,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_3_BORROW_IN,        sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_3_BORROW_OUT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_3_LAST_LINK_CARRY,  sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_3_LAST_COUNT,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_3_VOLUME,           sizeof(SBYTE),       1, fp, 0)) return 0;
  if(!lss_read(&mAUDIO_3_OUTPUT,           sizeof(SBYTE),       1, fp, 0)) return 0;
  if(!lss_read(&mAUDIO_3_INTEGRATE_ENABLE, sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mAUDIO_3_WAVESHAPER,       sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mSTEREO,                   sizeof(ULONG),       1, fp, 4)) return 0;
  
  //
  // Serial related variables
  //
  if(!lss_read(&mUART_RX_IRQ_ENABLE,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mUART_TX_IRQ_ENABLE,       sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mUART_TX_COUNTDOWN,        sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mUART_RX_COUNTDOWN,        sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mUART_SENDBREAK,           sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mUART_TX_DATA,             sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mUART_RX_DATA,             sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mUART_RX_READY,            sizeof(ULONG),       1, fp, 4)) return 0;
  
  if(!lss_read(&mUART_PARITY_ENABLE,       sizeof(ULONG),       1, fp, 4)) return 0;
  if(!lss_read(&mUART_PARITY_EVEN,         sizeof(ULONG),       1, fp, 4)) return 0;
  return 1;
}
