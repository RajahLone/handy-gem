...
{
  void *stack_address;
  int16_t *mask_address = (int16_t *)0xFF9202;
  int16_t *firebuttons = (int16_t *)0xFF9200;
  int16_t *keypad = (int16_t *)0xFF9202;
  uint32_t firebuttons_pressed;
  uint32_t keypad_pressed;
